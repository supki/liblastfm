...
addTrack playlist artist track apiKey sessionKey secret = runErrorT . callAPIsigned secret $
...
create title description apiKey sessionKey secret = runErrorT . callAPIsigned secret $
